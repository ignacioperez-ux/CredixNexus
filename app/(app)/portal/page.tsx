...
export default async function PortalPage() {
  ...
  if (!ctx) return null;
  const [categories, applications, myCases, caseTypes, access] = await Promise.all([
  ...
  return <Portal categories={categories} applications={applications} canFeedback={canFeedback} canViewIncidents={canViewIncidents} myCases={myCases} caseTypes={caseTypes} userName={ctx.name} />;
}
