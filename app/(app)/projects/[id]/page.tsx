...
import { getProject, getProjectTasks, getProjectValidations, getAnchorCaseContext } from "@/lib/projects/queries";
...
export default async function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [tasks, validations, workflows, workflowDefs, roster, anchor] = await Promise.all([
